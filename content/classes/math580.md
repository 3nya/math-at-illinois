...
While this class is technically self-contained, it is notoriously difficult without a previous background in combinatorics. Historically, students struggle more with the second half of this course, so it is strongly recommended that one has taken [[math412|MATH412]] or learned / self-studied graph theory beforehand. Both the exercises in West’s textbook and the past 580 comprehensive exams serve as excellent practice for the exams in this course. 
